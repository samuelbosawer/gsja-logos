...
<head>
  ...
  <meta property="og:title" content="Perayaan Natal GSJA Logos Kotaraja 2024" />
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="../index#beranda" class="">BERANDA</a></li>
          <li><a href="../index#tentang">TENTANG KAMI</a></li>
          <li><a href="../index#ibadah">IBADAH</a></li>
          <li><a href="../index#buletin">BULETIN</a></li>
          <li><a href="../index#kontak">KONTAK</a></li>
              ...
              <article class="article">
                ...
                <div class="meta-top">
                  <ul>
                    ...
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#"><time datetime="2020-01-01">12 Desember 2024</time></a></li>
                  </ul>
                </div><!-- End meta top -->
                ...
                <div class="content">
                  ...
                  <h4 class="text-center fw-bold">
                    Thema: <br> “Kembali ke Betlehem”
                  </h4>

                  <h5 class="text-center fw-bold mb-5">
                    Sub Thema: <br> “Kelahiran Yesus Kristus mengajak kita untuk berani melangkah dalam Iman dan Percaya menggapai Visi Gereja Sidang Jemaat Allah LOGOS.”
                  </h5>

                  <p>
                    Pada tanggal 12 Desember 2024, Gereja Sidang Jemaat Allah (GSJA) LOGOS Kotaraja dengan sukacita akan menyelenggarakan perayaan Natal sebagai bentuk refleksi atas kelahiran Sang Juru Selamat, Yesus Kristus. Ibadah ini menjadi momentum berharga untuk mempererat kebersamaan jemaat dalam semangat Natal yang penuh harapan.
                  </p>

                  <h3>Refleksi Thema: “Kembali ke Betlehem”</h3>
                  <p>
                  ...
                  <p>
                    Sub thema, “Kelahiran Yesus Kristus mengajak kita untuk berani melangkah dalam Iman dan Percaya menggapai Visi Gereja Sidang Jemaat Allah LOGOS,” menjadi pesan inspiratif yang relevan. Jemaat diingatkan bahwa kelahiran Yesus bukan hanya peristiwa sejarah, tetapi panggilan bagi setiap umat untuk memperkokoh iman, menghadapi tantangan hidup, dan berkontribusi pada misi gereja sesuai visi bersama.
                  </p>


                  <h3>Pelayan Firman</h3>
                  <p>
                    Pada kesempatan ini, Firman Tuhan akan dibawakan oleh gembala sidang jemaat GSJA LOGOS Kotaraja sendiri, Ibu Pdt. Elmitawati Sitepu, S.Pd.K. Khotbah beliau diharapkan mampu memberikan pencerahan, kekuatan rohani, dan dorongan untuk semakin mendekatkan diri kepada Tuhan.
                  </p>
